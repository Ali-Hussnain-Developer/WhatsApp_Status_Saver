...
public class ImageFragment extends Fragment {
    ...
    private void getData() {
        ...
        for (int i = 0; i < allFiles.length; i++) {
            ...
            if (Uri.fromFile(file).toString().endsWith(Constants.INSTANCE.getIMAGE_EXTENSION_PNG()) ||
                    Uri.fromFile(file).toString().endsWith(Constants.INSTANCE.getIMAGE_EXTENSION_JPG())
